...
import com.sforce.soap.enterprise.sobject.ConnectedApplication;
...
public class Main {
    ...
    static final String USERNAME = "wso2demosuite@wso2.com";
    static final String PASSWORD = "Samitha_2012XIPSw6bqoVQpdB9bkc6SzHw4I";
    ...
    private static void createAccounts() {
        ...
        ConnectedApplication connectedApplication = new ConnectedApplication();
        connectedApplication.setName("dd");
        try {
            connection.create(new ConnectedApplication[]{connectedApplication});
    ...
    private static void createAccounts2() {
