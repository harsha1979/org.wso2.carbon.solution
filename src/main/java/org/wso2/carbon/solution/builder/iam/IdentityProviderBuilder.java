...
/**
 * IdentityProviderBuilder transform the YAML artifact to the XML to execute the backend service.
 */
public class IdentityProviderBuilder {
    ...
    private Log log = LogFactory.getLog(IdentityProviderBuilder.class);
    ...
    /**
     * Transform YAML object to the JAXB.
     *
     * @param identityProvider_source
     * @param identityProvider_dest
     */
    public void buildIdentityProvider(org.wso2.carbon.solution.model.iam.idp.IdentityProvider
        ...
        if (identityProvider_source != null && identityProvider_dest != null) {
            log.debug("Building IdentityProvider, " + identityProvider_source.getIdentityProviderName());
            identityProvider_dest.setIdentityProviderName(identityProvider_source.getIdentityProviderName());
            identityProvider_dest
                    .setIdentityProviderDescription(identityProvider_source.getIdentityProviderDescription());
            ...
            log.debug("Building IdentityProvider, " + identityProvider_source.getIdentityProviderName() + " done.");
        }
    }


    /**
     * Building ProvisioingConnector.
     *
     * @param identityProvider_source
     * @param identityProvider_dest
     */
    ...
    /**
     * Building PermissionAndRoleConfig.
     *
     * @param identityProvider_source
     * @param identityProvider_dest
     */
    ...
    /**
     * Building JustInTimeProvisionConfig
     *
     * @param identityProvider_source
     * @param identityProvider_dest
     */
    ...
    /**
     * Building FederatedAuthenticatorConfig.
     *
     * @param identityProvider_source
     * @param identityProvider_dest
     */
