...
public class JustInTimeProvisioningConfig implements Serializable
{
     ...
     * @param isDumbMode
     */
    public JustInTimeProvisioningConfig(boolean isDumbMode, boolean isProvisioningEnabled, String provisioningUserStore, String userStoreClaimUri) {
        super();
    ...
    public String toString() {
        return new ToStringBuilder(this).append("isDumbMode", isDumbMode).append("isProvisioningEnabled", isProvisioningEnabled).append("provisioningUserStore", provisioningUserStore).append("userStoreClaimUri", userStoreClaimUri).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(userStoreClaimUri).append(provisioningUserStore).append(isProvisioningEnabled).append(isDumbMode).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(userStoreClaimUri, rhs.userStoreClaimUri).append(provisioningUserStore, rhs.provisioningUserStore).append(isProvisioningEnabled, rhs.isProvisioningEnabled).append(isDumbMode, rhs.isDumbMode).isEquals();
    }
